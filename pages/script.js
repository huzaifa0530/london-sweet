...
function emailaddress() {
    ...
    if (email == "") {
        ...
        document.getElementById("p3").innerHTML = "**Please Enter Your Accurate Email**"
    } 
    else{
...
function comment_mess () {
    ...
    var reg_comment = /^[a-zA-Z]{8,}$/

    if (comment == "") {

        document.getElementById("p4").innerHTML = "**Please Fill Out**"
    } else if (reg_comment.test(comment) != true) {

        document.getElementById("p4").innerHTML = "**Message Consist Of Minimum 8 Character*"
    } 
    else{
